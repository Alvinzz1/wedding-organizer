    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Tambah Events</h6>
        </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="card-body">
                            <h6>Tambah Data Upcoming Events</h6>
                            <form action="{{ route('submit-events') }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="lokasi" type="text" placeholder="Masukan Lokasi Tempat"></textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
