        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="d-flex align-items-center">
              ...
              <a href="{{ route('create-events') }}" class="btn btn-primary btn-sm ms-auto">Tambah</a>
            </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr style="border-bottom: 1px solid #dee2e6;">
                      ...
                      <td class="align-middle text-center">
                        <a href="{{ route('delete-events', $item->id) }}" class="btn btn-link text-xs text-danger text-gradient px-3 mb-0"><i class="far fa-trash-alt me-2"></i>Delete</a>
                        <a href="{{ route('edit-events', $item->id) }}" class="btn btn-link text-xs text-dark px-3 mb-0"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                      </td>
                    </tr>
                  </tbody>
                  @endforeach
