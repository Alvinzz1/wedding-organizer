    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Update Pricelist</h6>
        </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="card-body">
                            <h6>Update Data Pricelist</h6>
                            <form action="{{ url('update-pricelist', $price->id) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Nama Paket</label>
                                            <input class="form-control" type="text" name="nama_pricelist" placeholder="Masukan Nama Paket" value="{{ $price->nama_pricelist }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Harga Paket</label>
                                            <input class="form-control" type="number" name="harga" placeholder="Masukan Harga Paket" value="{{ $price->harga }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
