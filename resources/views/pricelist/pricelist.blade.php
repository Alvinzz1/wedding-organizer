    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Pricelist</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="d-flex align-items-center">
              <h6>Pricelist table</h6>
              <a href="{{ route('create-pricelist') }}" class="btn btn-primary btn-sm ms-auto">Tambah</a>
            </div>
            </div>
                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    <tr style="border-bottom: 1px solid #dee2e6;">
                      ...
                      <td class="align-middle text-center">
                        <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-xs font-weight-bold">{{ $item->nama_pricelist }}</h6>
                          </div>
                      </td>
                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle text-center">
                        ...
                        <a href="{{ route('edit-pricelist', $item->id) }}" class="btn btn-link text-xs text-dark px-3 mb-0"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true"></i>Edit</a>
                      </td>
                    </tr>
                  </tbody>
                  @endforeach
