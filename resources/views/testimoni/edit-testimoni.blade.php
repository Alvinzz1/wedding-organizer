    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Update Testimoni</h6>
        </nav>
            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        <div class="card-body">
                            <h6>Update Data Testimoni</h6>
                            <form action="{{ url('update-testimoni', $testi->id) }}" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Nama Pasangan</label>
                                            <input class="form-control" type="text" name="nama_pasangan" placeholder="Masukan Nama Pasangan" value="{{ $testi->nama_pasangan }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Tanggal Events</label>
                                            <input class="form-control" type="date" name="tanggal_events" placeholder="Masukan Tanggal Events" value="{{ $testi->tanggal_events }}">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="form-control-label">Lokasi</label>
                                            <textarea class="form-control" name="lokasi" type="text" placeholder="Masukan Lokasi Pernikahan">{{ $testi->lokasi }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <video class="mt-3" id="videoPreview" width="320" height="240" controls>
                                                <source src="{{ $testi->video ? asset('storage/' . $testi->video) : '' }}" type="video/mp4">
